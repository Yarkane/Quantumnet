...
///// OQS_TEMPLATE_FRAGMENT_ASSIGN_SIG_ALG_START
    ...
    case NID_picnic3l3:
    case NID_p384_picnic3l3:
      return OQS_SIG_alg_picnic3_L3;
    case NID_picnic3l5:
    case NID_p521_picnic3l5:
...
///// OQS_TEMPLATE_FRAGMENT_ASSIGN_OQS_NID_START
    ...
    case NID_p384_picnic3l3:
      return NID_picnic3l3;
    case NID_p521_picnic3l5:
      return NID_picnic3l5;
    case NID_p256_rainbowIaclassic:
    case NID_rsa3072_rainbowIaclassic:
      return NID_rainbowIaclassic;
    case NID_p521_rainbowVcclassic:
      return NID_rainbowVcclassic;
    case NID_p256_sphincsharaka128frobust:
    case NID_rsa3072_sphincsharaka128frobust:
...
///// OQS_TEMPLATE_FRAGMENT_CHECK_IF_KNOWN_NID_START
        ...
        nid != NID_picnic3l3 &&
        nid != NID_p384_picnic3l3 &&
        nid != NID_picnic3l5 &&
        nid != NID_p521_picnic3l5 &&
        nid != NID_rainbowIaclassic &&
        nid != NID_p256_rainbowIaclassic &&
        nid != NID_rsa3072_rainbowIaclassic &&
        nid != NID_rainbowVcclassic &&
        nid != NID_p521_rainbowVcclassic &&
...
DEFINE_OQS_EVP_METHODS(picnic3l3, NID_picnic3l3, "picnic3l3", "OpenSSL Picnic3 L3 algorithm")
DEFINE_OQS_EVP_METHODS(p384_picnic3l3, NID_p384_picnic3l3, "p384_picnic3l3", "OpenSSL ECDSA p384 Picnic3 L3 algorithm")
DEFINE_OQS_EVP_METHODS(picnic3l5, NID_picnic3l5, "picnic3l5", "OpenSSL Picnic3 L5 algorithm")
DEFINE_OQS_EVP_METHODS(p521_picnic3l5, NID_p521_picnic3l5, "p521_picnic3l5", "OpenSSL ECDSA p521 Picnic3 L5 algorithm")
...
DEFINE_OQS_EVP_METHODS(rainbowVcclassic, NID_rainbowVcclassic, "rainbowVcclassic", "OpenSSL Rainbow-Vc-Classic algorithm")
DEFINE_OQS_EVP_METHODS(p521_rainbowVcclassic, NID_p521_rainbowVcclassic, "p521_rainbowVcclassic", "OpenSSL ECDSA p521 Rainbow-Vc-Classic algorithm")
