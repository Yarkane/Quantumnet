...
#define SSL_aOQS_SIG_DEFAULT 0x00000100U
/* ECDSA p256 - OQS Default Signature Algorithm auth */
#define SSL_aP256_OQS_SIG_DEFAULT 0x00000200U
/* RSA3072 - OQS Default Signature Algorithm auth */
#define SSL_aRSA3072_OQS_SIG_DEFAULT 0x00000400U
/* Dilithium-2 auth */
#define SSL_aDILITHIUM2 0x00000800U
/* ECDSA p256 - Dilithium-2 auth */
#define SSL_aP256_DILITHIUM2 0x00001000U
/* RSA3072 - Dilithium-2 auth */
#define SSL_aRSA3072_DILITHIUM2 0x00002000U
/* Dilithium-3 auth */
#define SSL_aDILITHIUM3 0x00004000U
/* ECDSA p256 - Dilithium-3 auth */
#define SSL_aP256_DILITHIUM3 0x00008000U
/* RSA3072 - Dilithium-3 auth */
#define SSL_aRSA3072_DILITHIUM3 0x00010000U
/* Dilithium-4 auth */
#define SSL_aDILITHIUM4 0x00020000U
/* ECDSA p384 - Dilithium-4 auth */
#define SSL_aP384_DILITHIUM4 0x00040000U
/* Falcon-512 auth */
#define SSL_aFALCON512 0x00080000U
/* ECDSA p256 - Falcon-512 auth */
#define SSL_aP256_FALCON512 0x00100000U
/* RSA3072 - Falcon-512 auth */
#define SSL_aRSA3072_FALCON512 0x00200000U
/* Falcon-1024 auth */
#define SSL_aFALCON1024 0x00400000U
/* ECDSA p521 - Falcon-1024 auth */
#define SSL_aP521_FALCON1024 0x00800000U
/* Picnic L1 FS auth */
#define SSL_aPICNICL1FS 0x01000000U
/* ECDSA p256 - Picnic L1 FS auth */
#define SSL_aP256_PICNICL1FS 0x02000000U
/* RSA3072 - Picnic L1 FS auth */
#define SSL_aRSA3072_PICNICL1FS 0x04000000U
/* Picnic L1 full auth */
...
/* Picnic3 L3 auth */
#define SSL_aPICNIC3L3 0x200000000U
/* ECDSA p384 - Picnic3 L3 auth */
#define SSL_aP384_PICNIC3L3 0x400000000U
/* Picnic3 L5 auth */
#define SSL_aPICNIC3L5 0x800000000U
/* ECDSA p521 - Picnic3 L5 auth */
#define SSL_aP521_PICNIC3L5 0x1000000000U
/* Rainbow-Ia-Classic auth */
#define SSL_aRAINBOWIACLASSIC 0x2000000000U
/* ECDSA p256 - Rainbow-Ia-Classic auth */
#define SSL_aP256_RAINBOWIACLASSIC 0x4000000000U
/* RSA3072 - Rainbow-Ia-Classic auth */
#define SSL_aRSA3072_RAINBOWIACLASSIC 0x8000000000U
/* Rainbow-Vc-Classic auth */
#define SSL_aRAINBOWVCCLASSIC 0x10000000000U
/* ECDSA p521 - Rainbow-Vc-Classic auth */
#define SSL_aP521_RAINBOWVCCLASSIC 0x20000000000U
/* SPHINCS+-Haraka-128f-robust auth */
#define SSL_aSPHINCSHARAKA128FROBUST 0x40000000000U
/* ECDSA p256 - SPHINCS+-Haraka-128f-robust auth */
#define SSL_aP256_SPHINCSHARAKA128FROBUST 0x80000000000U
/* RSA3072 - SPHINCS+-Haraka-128f-robust auth */
#define SSL_aRSA3072_SPHINCSHARAKA128FROBUST 0x100000000000U
...
#define SSL_PKEY_PICNICL1FS 25
#define SSL_PKEY_P256_PICNICL1FS 26
#define SSL_PKEY_RSA3072_PICNICL1FS 27
...
#define SSL_PKEY_PICNIC3L3 34
#define SSL_PKEY_P384_PICNIC3L3 35
#define SSL_PKEY_PICNIC3L5 36
#define SSL_PKEY_P521_PICNIC3L5 37
#define SSL_PKEY_RAINBOWIACLASSIC 38
#define SSL_PKEY_P256_RAINBOWIACLASSIC 39
#define SSL_PKEY_RSA3072_RAINBOWIACLASSIC 40
#define SSL_PKEY_RAINBOWVCCLASSIC 41
#define SSL_PKEY_P521_RAINBOWVCCLASSIC 42
#define SSL_PKEY_SPHINCSHARAKA128FROBUST 43
#define SSL_PKEY_P256_SPHINCSHARAKA128FROBUST 44
#define SSL_PKEY_RSA3072_SPHINCSHARAKA128FROBUST 45

#define SSL_PKEY_NUM 46
...
#define OQS_KEM_CURVEID(nid) \
  ...
  (nid == NID_kyber90s512 ? 0x0229 : \
  (nid == NID_kyber90s768 ? 0x022A : \
  (nid == NID_kyber90s1024 ? 0x022B : \
...
#define OQS_KEM_NID(curveID) \
  ...
  (curveID == 0x0206 || curveID == 0x2F06 ? NID_bike1l1cpa : \
  ...
  (curveID == 0x021A || curveID == 0x2F1A ? NID_firesaber : \
  (curveID == 0x021B || curveID == 0x2F1B ? NID_sidhp434 : \
  (curveID == 0x021C || curveID == 0x2F1C ? NID_sidhp503 : \
  (curveID == 0x021D || curveID == 0x2F1D ? NID_sidhp610 : \
  (curveID == 0x021E || curveID == 0x2F1E ? NID_sidhp751 : \
  (curveID == 0x021F || curveID == 0x2F1F ? NID_sikep434 : \
  (curveID == 0x0220 || curveID == 0x2F20 ? NID_sikep503 : \
  (curveID == 0x0221 || curveID == 0x2F21 ? NID_sikep610 : \
  (curveID == 0x0222 || curveID == 0x2F22 ? NID_sikep751 : \
  (curveID == 0x0229 || curveID == 0x2F29 ? NID_kyber90s512 : \
  (curveID == 0x022A || curveID == 0x2F2A ? NID_kyber90s768 : \
  (curveID == 0x022B || curveID == 0x2F2B ? NID_kyber90s1024 : \
...
#define TLSEXT_SIGALG_picnic3l3 0xfe1e
#define TLSEXT_SIGALG_p384_picnic3l3 0xfe1f
#define TLSEXT_SIGALG_picnic3l5 0xfe20
#define TLSEXT_SIGALG_p521_picnic3l5 0xfe21
