...
///// OQS_TEMPLATE_FRAGMENT_DEFINE_TLS12_SIGALGS_START
    ...
    TLSEXT_SIGALG_picnic3l3,
    TLSEXT_SIGALG_p384_picnic3l3,
    TLSEXT_SIGALG_picnic3l5,
    TLSEXT_SIGALG_p521_picnic3l5,
...
///// OQS_TEMPLATE_FRAGMENT_POPULATE_SIGALG_TBL_START
    ...
    {"picnic3l1", TLSEXT_SIGALG_picnic3l1,
     ...
     NID_undef, NID_undef},
    {"p256_picnic3l1", TLSEXT_SIGALG_p256_picnic3l1,
     NID_undef, -1, EVP_PKEY_P256_PICNIC3L1, SSL_PKEY_P256_PICNIC3L1,
     NID_undef, NID_undef},
    {"rsa3072_picnic3l1", TLSEXT_SIGALG_rsa3072_picnic3l1,
     NID_undef, -1, EVP_PKEY_RSA3072_PICNIC3L1, SSL_PKEY_RSA3072_PICNIC3L1,
     NID_undef, NID_undef},
    {"picnic3l3", TLSEXT_SIGALG_picnic3l3,
     NID_undef, -1, EVP_PKEY_PICNIC3L3, SSL_PKEY_PICNIC3L3,
     NID_undef, NID_undef},
    {"p384_picnic3l3", TLSEXT_SIGALG_p384_picnic3l3,
     NID_undef, -1, EVP_PKEY_P384_PICNIC3L3, SSL_PKEY_P384_PICNIC3L3,
     NID_undef, NID_undef},
    {"picnic3l5", TLSEXT_SIGALG_picnic3l5,
     NID_undef, -1, EVP_PKEY_PICNIC3L5, SSL_PKEY_PICNIC3L5,
     NID_undef, NID_undef},
    {"p521_picnic3l5", TLSEXT_SIGALG_p521_picnic3l5,
     NID_undef, -1, EVP_PKEY_P521_PICNIC3L5, SSL_PKEY_P521_PICNIC3L5,
     NID_undef, NID_undef},
...
///// OQS_TEMPLATE_FRAGMENT_MAP_SIGALG_TO_BIT_SECURITY_START
            ...
            secbits = 128;
        else if(lu->sigalg == TLSEXT_SIGALG_picnic3l3)
            secbits = 192;
        else if(lu->sigalg == TLSEXT_SIGALG_p384_picnic3l3)
            secbits = 192;
        else if(lu->sigalg == TLSEXT_SIGALG_picnic3l5)
            secbits = 256;
        else if(lu->sigalg == TLSEXT_SIGALG_p521_picnic3l5)
            secbits = 256;
...
///// OQS_TEMPLATE_FRAGMENT_ADD_CERT_CHAIN_CHECKS_START
    ...
    tls1_check_chain(s, NULL, NULL, NULL, SSL_PKEY_PICNIC3L3);
    tls1_check_chain(s, NULL, NULL, NULL, SSL_PKEY_P384_PICNIC3L3);
    tls1_check_chain(s, NULL, NULL, NULL, SSL_PKEY_PICNIC3L5);
    tls1_check_chain(s, NULL, NULL, NULL, SSL_PKEY_P521_PICNIC3L5);
